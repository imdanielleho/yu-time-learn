...
const ValueProposition = () => {
  const values = [
    {
      icon: <Award size={32} className="text-yutime-vibrant" />,
    ...
    {
      icon: <BookOpen size={32} className="text-yutime-vibrant" />,
    ...
    {
      icon: <Wallet size={32} className="text-yutime-vibrant" />,
  ...
  return (
    <section className="bg-yutime-cream py-12 md:py-32">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
          {values.map((value, index) => (
            <div key={index} className="text-center space-y-6">
              <div className="flex justify-center">
                <div className="w-16 h-16 rounded-full bg-yutime-light-green flex items-center justify-center shadow-lg">
                  {value.icon}
                </div>
              </div>
              <h3 className="text-xl font-bold text-yutime-charcoal">{value.title}</h3>
