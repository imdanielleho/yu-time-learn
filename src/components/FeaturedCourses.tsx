    ...
    course: typeof courses[0];
      ...
      <Link to={`/courses/${course.id}`} className="block flex-1 flex flex-col">
        ...
        <div className="flex-1 flex flex-col p-4 md:p-5">
          ...
          <h3 className="text-lg font-semibold mb-3 text-yutime-primary transition-colors">
            {course.title}
          </h3>
  ...
  return <section id="courses" className="bg-yutime-neutral/20 py-16 md:py-24 lg:py-32">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="mb-10 md:mb-12 text-center">
          <p className="text-base font-medium text-yutime-secondary tracking-wide uppercase mb-3">精選課程</p>
          <h2 className="text-3xl md:text-4xl font-serif text-yutime-primary mb-4">今天，遇見更好的自己</h2>
