        ...
        <div className="max-w-6xl mx-auto">
          ...
          {isMobile ? <div className="w-full max-w-sm mx-auto sm:max-w-none overflow-visible">
              <Carousel className="w-full overflow-visible" setApi={setApi}>
                <CarouselContent className="-ml-4 md:-ml-4 overflow-visible">
                  {courses.map(course => <CarouselItem key={course.id} className="pl-4 md:pl-4 md:basis-1/2 lg:basis-1/3 py-2">
