    ...
    <div className="flex items-center space-x-3 h-10">
      {isLoggedIn && (
        <button 
          ...
          className="bg-yutime-blue hover:bg-yutime-blue/90 text-white h-10 px-4 py-2 rounded-md font-medium text-base transition-all shadow-sm hover:shadow flex items-center max-w-fit lg:max-w-44"
        >
