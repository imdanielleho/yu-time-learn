...
const communityAvatars = ["https://randomuser.me/api/portraits/women/32.jpg", "https://randomuser.me/api/portraits/men/45.jpg", "https://randomuser.me/api/portraits/women/68.jpg", "https://randomuser.me/api/portraits/men/52.jpg", "https://randomuser.me/api/portraits/women/44.jpg"];
const Testimonials = () => {
  return <section id="testimonials" className="section bg-gradient-to-br from-yutime-cream via-yutime-softWhite to-yutime-sand/30">
      <div className="container">
        ...
        {/* Community section */}
        <div className="text-center bg-yutime-sage/5 rounded-2xl p-8 backdrop-blur-sm border border-yutime-sage/10">
          <div className="flex justify-center mb-4 -space-x-2">
            {communityAvatars.map((avatar, index) => <div key={index} className="w-12 h-12 rounded-full overflow-hidden border-2 border-yutime-sage">
                <img src={avatar} alt={`Community member ${index + 1}`} className="w-full h-full object-cover" />
              </div>)}
            <div className="w-12 h-12 rounded-full bg-yutime-gold border-2 border-yutime-sage flex items-center justify-center">
