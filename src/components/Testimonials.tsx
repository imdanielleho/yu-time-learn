      ...
      <div className="container">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="bg-yutime-softWhite rounded-2xl p-6 shadow-warm py-[27px]">
        ...
        {/* Community section */}
        <div className="max-w-md mx-auto rounded-2xl p-6 backdrop-blur-sm border border-yutime-sand_dark/10 shadow-soft bg-yutime-softWhite">
          <div className="flex items-center gap-4">
            {/* Avatar section */}
            <div className="flex -space-x-2">
              {communityAvatars.map((avatar, index) => (
                <div key={index} className="w-12 h-12 rounded-full overflow-hidden border-0">
