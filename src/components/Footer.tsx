...
const Footer = () => {
  ...
  return (
    <footer className="bg-yutime-gray-800 text-white py-12" style={{ paddingBottom: '100px' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#courses" onClick={(e) => scrollToSection(e, 'courses')} className="text-gray-300 hover:text-white transition-colors">Courses</a></li>
              <li><a href="#faq" onClick={(e) => scrollToSection(e, 'faq')} className="text-gray-300 hover:text-white transition-colors">FAQ</a></li>
