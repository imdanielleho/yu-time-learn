...
const LearningProcess = () => {
  ...
  return (
    <section className="bg-yutime-navy py-20 md:py-32">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">How YŪTIME Works</h2>
          <p className="max-w-2xl mx-auto text-white/85 text-xl leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto">
            ...
            {steps.map((step, index) => (
              <div key={index} className="text-center">
                <div className="relative mb-8">
                  {/* Main icon container */}
                  <div className="w-20 h-20 bg-yutime-bronze rounded-full flex items-center justify-center mx-auto mb-6 shadow-warm relative">
                    {step.icon}
                    {/* Step number in small circle at top-right */}
                    <div className="absolute -top-2 -right-2 w-8 h-8 bg-yutime-navy rounded-full flex items-center justify-center border-2 border-white shadow-lg">
          ...
          {/* Ready to begin section - refined styling */}
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 w-fit mx-auto border border-white/20">
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1 text-left">
                ...
                <Button 
                  ...
                  className="bg-yutime-bronze hover:bg-yutime-bronzeLight text-yutime-navy px-8 py-3 text-lg rounded-xl font-bold shadow-warm hover-lift"
                >
