    ...
    <section className="bg-yutime-indigo py-20 md:py-32">
      <div className="container max-w-7xl mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {/* Ready to begin section - converted to two columns with reduced width */}
          <div className="max-w-2xl mx-auto bg-white/10 rounded-2xl p-8 backdrop-blur-sm">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              {/* Left column - Icon */}
              <div className="flex justify-center md:justify-start">
                <div className="w-20 h-20 bg-yutime-gold rounded-full flex items-center justify-center">
