    ...
    <section className="bg-yutime-primary py-20 md:py-32">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-white/90 text-xl leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto">
            ...
            {steps.map((step, index) => (
              <div key={index} className="text-center">
                <div className="relative mb-8">
                  {/* Main icon container */}
                  <div className="w-20 h-20 bg-yutime-accent rounded-full flex items-center justify-center mx-auto mb-6 shadow-warm relative">
                    {step.icon}
                    {/* Step number in small circle at top-right */}
                    <div className="absolute -top-2 -right-2 w-8 h-8 bg-white rounded-full flex items-center justify-center border-2 border-yutime-primary shadow-lg">
          ...
          <div className="bg-white/10 rounded-2xl p-6 backdrop-blur-sm w-fit mx-auto">
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1 text-left">
                ...
                <Button 
                  ...
                  className="bg-yutime-accent hover:bg-yutime-accent/90 text-yutime-gray-800 px-8 py-3 text-lg rounded-xl font-bold shadow-soft hover-lift"
                >
